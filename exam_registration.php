            ...
            <section class="content">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading"><h4>Exam Registration</h4></div>
                        <div class="panel-body">
                            <!--                       Message-->
                            <form class="form-horizontal" style="margin-left: 115px">
                                <div id="messageExam"></div>
                            <?php
                            while($row = $stmt->fetch(PDO::FETCH_OBJ)){
                                $course = $row->CourseName;
                                $course_ID = $row->course_ID;
                                ?>
                                &nbsp;<input type="checkbox" value="<?php echo $course_ID?>" name="course[]" id="course[]" class="nav-link"/>&nbsp;&nbsp;<label for="course[]" style="font-size: 15px"><?php echo $course?></label>
                            <?php }?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="col-sm-9">
                                                <label for="examCentre">Exam Centre:</label>
                                                <select id="examCentre" name="examCentre" class="form-control">
                                                    <option disabled>SELECT Exam Centre</option>
                                                    <option>UNZA</option>
                                                    <option>CBU</option>
                                                </select>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="col-sm-9">
                                                <a href="#"  class="btn btn-success" id="ExamRegistration" name="ExamRegistration" >Confirm</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
