...
//                                                      checkifFile($);
                                                      for($i=0; $i<$total_files;$i++){
                                                         ...
                                                         if(checkifFile($_FILES["upload"]["name"][$i])){
                                                             $storageFolder = "Tutorials/".$_FILES['upload']['name'][$i];
                                                             $courseCode = $_POST["courseCode"];
//                                                             $videoName = $_POST["videoName"];
                                                             $description = $_POST["description"];

                                                             $sqlx = "INSERT INTO tutorial(tutorialID, videoName, course_id, description)VALUES(?,?,?,?)";
                                                             ...
                                                             if(move_uploaded_file($tmpFilePath, $storageFolder)) {
                                                                 ...
                                                                 echo "Failed to Upload files: ".$_FILES["upload"]["name"][$i];
                                                             }

                                                             }
                                                         }else{
                                                             echo "Not Supported files: <b>".$_FILES["upload"]["name"][$i]."</b> \n";
                                                         }
                                                      }
...
<!--                                                        <a href="#" id="saveCourse" class="btn btn-success">Save</a>-->
                                                        <button name="saveVideo" class="btn btn-success" type="submit">Upload</button>
                                                    </div>
                                                </div>
                                            </form>
