                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title"><h1 class="text-blue">Approve Payments</h1></h4>
                                            <hr>
                                            <div id="StudentApprovedPayment"></div>
                                            ...
                                            <table class='table table-sm table-bordered table-striped table-hover'>
                                                ...
                                                <tr>
                                                    <!--                                                    id 	student_id 	semester_id 	paid 	paymentType 	paymentimg 	BatchNumber 	Narration 	due 	balance 	date_updated -->
                                                    <th>#</th>
                                                    <th>Full Name</th>
                                                    <th>Batch Number</th>
                                                    <th>Paid</th>
                                                ...
                                                <tbody id="approvepaymenttudents">
