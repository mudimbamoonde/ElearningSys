                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="card-title"><h1>Add Student</h1></div>
                                            <hr>
                                            ...
                                            <form class="form-sample">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" id="oname" name="oname" style="border: groove" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="date"  id="dob" name="dob" style="border: groove" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <select  id="program_study" name="program_study" style="border: groove" class="form-control">
                                                                    ...
                                                                    require_once 'include/config.php';
                                                                      ...
                                                                      while ($row = $check->fetch(PDO::FETCH_OBJ)){
                                                                          echo "<option value='$row->shortname'>$row->programName</option>";
                                                                      }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <a href="#" id="saveStudent" class="btn btn-success">Save</a>
                                                    </div>
                                                </div>
                                            </form>
