                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="form-sample">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" id="semesterValue" name="semesterValue" style="border: groove" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <a href="#" id="saveSemester" class="btn btn-success">Save</a>
                                                    </div>
                                                </div>
                                            </form>
